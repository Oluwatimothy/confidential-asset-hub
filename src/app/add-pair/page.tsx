        ...
        <div className="flex items-start gap-3">
          ...
          <div className="space-y-1 text-xs text-zinc-400 leading-relaxed">
            ...
            <p>
              ...
              commit it, and push to GitHub. Vercel automatically builds and redeploys
              the app on every push, so the pair goes live once that deploy finishes,
              typically a minute or two, no manual build step required.
            </p>
          </div>
        </div>
      </div>
