...
function TokenDecryptCard({ pair }: { pair: RegistryPair }) {
  ...
  async function handleRefresh() {
    console.log('REFRESH CLICKED for', contractAddress);
    await recheckPermit();
    console.log('permit rechecked, hasPermit:', hasPermit);
    const result = await refetchBalance();
    console.log('refetch result:', result.data?.toString(), result.error);
